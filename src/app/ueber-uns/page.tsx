  ...
  return (
    ...
    <div className="mx-auto max-w-article px-4 sm:px-6 py-14">
      ...
      <div className="prose-rop mt-8">
        ...
        <div className="relative my-24 rounded-2xl bg-navy p-6 pt-20 text-center not-prose">
          ...
          <p className="text-lg font-extrabold text-white">
            Tim <span className="ml-1 text-sm font-normal text-[#8A8FA3]">Gründer &amp; Herausgeber</span>
          </p>
          <p className="mx-auto mt-4 max-w-lg text-[15px] leading-relaxed text-[#C7CAD8]">
          ...
          <p className="mx-auto mt-3 max-w-lg text-[15px] leading-relaxed text-[#C7CAD8]">
        ...
        <div className="relative my-24 rounded-2xl bg-navy p-6 pt-20 text-center not-prose">
          ...
          />
          <p className="text-lg font-extrabold text-white">
            Claude <span className="ml-1 text-sm font-normal text-[#8A8FA3]">KI-Assistent von Tim</span>
          </p>
          <p className="mx-auto mt-4 max-w-lg text-[15px] leading-relaxed text-[#C7CAD8]">
