...
// Offizielle Marken-Glyphen (Pfaddaten: Simple-Icons-Katalog, viewBox 24×24) für
// die Plattform-Navigation. Nominative Nutzung: Die Icons kennzeichnen unsere
...
export function PlatformIcon({ platform, className }: { platform: Platform; className?: string }) {
  if (platform === "pc") {
    // Neutrales Desktop-Monitor-Icon im Fill-Stil der Marken-Glyphen.
    return (
      <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
        <path d="M2 3h20a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1h-8v2h3a1 1 0 1 1 0 2H7a1 1 0 1 1 0-2h3v-2H2a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1zm1 2v10h18V5H3z" />
      </svg>
    );
  }
  return (
