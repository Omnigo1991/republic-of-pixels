            ...
            rendered = (
              ...
              >
                {block.items.map((s, j) => (
                  ...
                  <div
                    key={j}
                    className="relative overflow-hidden rounded-[18px] bg-[linear-gradient(120deg,#02F0D1,#FF2E97)] px-5 py-5 text-left"
                  >
                    ...
                    <p className="mt-1.5 break-words text-[13px] font-semibold leading-snug text-[#0C0B1A]">{s.label}</p>
                  </div>
                ))}
              </div>
            );
