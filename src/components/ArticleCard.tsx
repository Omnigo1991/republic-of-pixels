...
export function ArticleCard({ article }: { article: Article }) {
  ...
  return (
    <Link
      ...
      className="group pixel-notch flex flex-col overflow-hidden border border-border-subtle bg-surface-card transition-all duration-300 hover:bg-surface-hover"
    >
