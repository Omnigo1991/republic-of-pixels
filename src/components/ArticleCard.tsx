...
export function ArticleCard({ article }: { article: Article }) {
  ...
  return (
    <Link
      ...
      className="group flex flex-col overflow-hidden rounded-2xl border border-border-subtle bg-surface-card transition-all duration-300 hover:bg-surface-hover hover:shadow-glow"
    >
      ...
      <div className="flex flex-1 flex-col gap-3 p-5">
        ...
        {kicker && (
          <p className="text-[12px] font-bold uppercase tracking-wider text-accent line-clamp-1">
            {kicker}
          </p>
        )}
