# Bildregeln für Instagram-Posts
...
**Offizielles Artwork ist der Standard.** Gibt es zur Story ein Spiel, wird
Artwork geholt (Steam, dann IGDB). Das Pressebild aus der Nachricht kommt nur
zum Zug, wenn das Bild SELBST die Nachricht ist: erste Screenshots, ein
Trailer-Standbild, eine bestimmte Person.
...
Schriftzug suchen; das Bibliothekscover nur, wenn nichts anderes da ist.

**Bei alten Spielen: neuere Fassung bevorzugen.** Erst nach Grafik der
Neuauflage oder Portierung suchen, das Originalcover von damals als Rückfall.

**Firmen- und Branchennachrichten ohne Spiel** (Entlassungen, Preise,
Quartalszahlen): offizielles Material des Studios oder Herstellers nutzen
(Produktbild, Firmengrafik). Kein geliehenes, unpassendes Pressebild mehr.
...
**Helle Bilder sind erlaubt.** Das Artwork bestimmt die Helligkeit; der
Verlauf sorgt weiterhin dafür, dass die Schlagzeile unten lesbar bleibt. Ein
...
> ACHTUNG, offener Punkt: Das ist die UMKEHRUNG unserer heutigen Regel. Der
> Motiv-Sucher optimiert bis heute auf eine RUHIGE Zone hinter der
> Schlagzeile. Zwei Versuche, stattdessen auf Struktur zu optimieren, sind am
...
Reels bekommen mehr Reichweite, also gehört die zugkräftigste Meldung darauf.
...
Bei ernsten Themen ohne Pointe und ohne Ironie, aber sie fehlt nie.
...
**Weicher Verlauf über rund 40 % der Höhe**, wie heute. Kein harter Schnitt.
...
drei, mit kleinerem Unterschied. Lesbarkeit bleibt gesichert, das Raster
wirkt einheitlicher.

## 8. Der Grundsatz für alle Zweifelsfälle

**Ein schwacher Post ist schlimmer als ein fehlender.** Im Zweifel lieber
einen Slot verfallen lassen als etwas Mittelmässiges zeigen.
